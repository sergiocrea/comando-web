...
import { createApi, createMockApi } from './api.js?v=12';
import { SECTIONS, consolaGlobal, globalActions } from './sections.js?v=21';
 ...
 *
 * Y los `<input type="date">` del rango, por lo mismo que el desplegable: el
 * `click` es abrir el calendario, no elegir el día.
 */
