...
import { createApi, createMockApi } from './api.js?v=17';
import { SECTIONS, globalActions } from './sections.js?v=28';
import { chatView, paintChat, loadHistory, openChat, closeChat, chatPreference } from './chat.js?v=4';
