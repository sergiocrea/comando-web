...
(function () {
  ...
  const LAYOUTS = {
    ...
    tall: {
      w: 360, h: 440,
      meta: { x: 12, y: 12, w: 336, h: 122 },
      crm: { x: 12, y: 290, w: 336, h: 140 },
      hub: { cx: 250, cy: 212, w: 126, h: 40 },
      chipLead: { cx: 116, cy: 212, w: 128, h: 26 },
      chipSale: { cx: 252, cy: 168, w: 144, h: 26 },
      forward: 'M90 134 C 46 186, 46 238, 90 290',
      back: 'M270 290 C 314 238, 314 186, 270 134',
      slots: { xs: [60, 120, 180, 240, 300], ys: [362, 404], r: 16 },
    },
  };
