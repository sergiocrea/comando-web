...
const PRICING_CONFIG = {
  ...
  faq: [
    ...
    { q: '¿Qué cuenta como comando?', a: 'Cada pedido que le haces a Comando por WhatsApp, por texto o por audio. Las confirmaciones («sí», «ok») y las respuestas de Comando no cuentan. Una nota de voz cuenta como 1,5 comandos.' },
    { q: '¿Qué pasa si uso más comandos de los incluidos?', a: 'Te avisamos al 80 %. Puedes sumar paquetes de 500 comandos por $8 o subir de plan.' },
